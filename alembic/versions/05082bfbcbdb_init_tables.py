...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Form: Complaint name *",
        ),
        sa.Column(
            "quality_issue_warranty",
            sa.String(length=100),
            nullable=True,
            comment="Form: Quality issue / Warranty *",
        ),
        sa.Column(
            "customer", sa.String(length=255), nullable=True, comment="Form: Customer *"
        ),
        sa.Column(
            "customer_plant_name",
            sa.String(length=255),
            nullable=True,
            comment="Form: Customer plant name *",
        ),
        sa.Column(
            "avocarbon_plant",
            sa.Enum(
            ...
            nullable=True,
            comment="Form: AVOCarbon plant *",
        ),
        sa.Column(
            "avocarbon_product_type",
            sa.String(length=100),
            nullable=True,
            comment="Form: AVOCarbon product type *",
        ),
        sa.Column(
            "potential_avocarbon_process_linked_to_problem",
            sa.String(length=500),
            nullable=True,
            comment="Form: Potential AVOCarbon process *",
        ),
        sa.Column(
            "product_line",
            sa.Enum(
        ...
        sa.Column(
            ...
            sa.String(length=255),
            nullable=True,
            comment="Form: Concerned application *",
        ),
        sa.Column(
            "customer_complaint_date",
            sa.Date(),
            nullable=True,
            comment="Form: Customer complaint date *",
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="Form: Complaint description * (max 2000 chars)",
        ),
        sa.Column(
            "defects", sa.String(length=255), nullable=True, comment="Form: Defects *"
        ),
        sa.Column(
            "quality_manager",
            sa.Integer(),
            nullable=True,
            comment="Form: Quality manager *",
        ),
        sa.Column(
            "repetitive_complete_with_number",
            sa.Text(),
            nullable=True,
            comment="Form: REPETITIVE number *",
        ),
        sa.Column(
            "reported_by",
            sa.Integer(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="User assigned to handle complaint",
        ),
        sa.Column(
            "status",
            sa.String(length=50),
    ...
    op.create_index(
        op.f("ix_complaints_assigned_to"), "complaints", ["assigned_to"], unique=False
    )
    op.create_index(
        op.f("ix_complaints_created_at"), "complaints", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_complaints_customer_complaint_date"),
        "complaints",
        ["customer_complaint_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_complaints_product_line"), "complaints", ["product_line"], unique=False
    )
    op.create_index(
        op.f("ix_complaints_quality_manager"),
        "complaints",
        ["quality_manager"],
        unique=False,
    )
    op.create_index(
        op.f("ix_complaints_reported_by"), "complaints", ["reported_by"], unique=False
    )
    op.create_index(
        op.f("ix_complaints_severity"), "complaints", ["severity"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column(
            "checksum", sa.String(length=64), nullable=True, comment="SHA-256 hash"
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        "idx_kb_chunks_tsv", "kb_chunks", ["tsv"], unique=False, postgresql_using="gin"
    )
    op.create_index(
        op.f("ix_kb_chunks_file_id"), "kb_chunks", ["file_id"], unique=False
    )
    op.create_table(
        "reports",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_reports_complaint_id"), "reports", ["complaint_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_reports_report_number"), "reports", ["report_number"], unique=True
    )
    op.create_index(
        op.f("ix_reports_reviewed_by"), "reports", ["reviewed_by"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=10),
            nullable=False,
            comment="D1|D2|D3|D4|D5|D6|D7|D8",
        ),
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            comment="draft|submitted|validated|rejected",
        ),
        sa.Column(
            "data",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
            comment="Flexible JSON storage for step-specific data",
        ),
    ...
    op.create_index(
        op.f("ix_report_steps_created_at"), "report_steps", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_report_steps_report_id"), "report_steps", ["report_id"], unique=False
    )
    op.create_index(
        op.f("ix_report_steps_status"), "report_steps", ["status"], unique=False
    )
    op.create_table(
        "step_files",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_step_files_file_id"), "step_files", ["file_id"], unique=False
    )
    op.create_index(
        op.f("ix_step_files_report_step_id"),
        "step_files",
        ["report_step_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("report_step_id", sa.Integer(), nullable=False),
        sa.Column(
            "decision", sa.String(length=20), nullable=False, comment="pass|fail"
        ),
        sa.Column(
            "missing", sa.ARRAY(sa.Text()), nullable=True, comment="Missing elements"
        ),
        sa.Column(
            "issues", sa.ARRAY(sa.Text()), nullable=True, comment="Identified issues"
        ),
        sa.Column(
            "suggestions",
            sa.ARRAY(sa.Text()),
    ...
    op.create_index(
        op.f("ix_step_validation_decision"),
        "step_validation",
        ["decision"],
        unique=False,
    )
    op.create_index(
        op.f("ix_step_validation_report_step_id"),
        "step_validation",
        ["report_step_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_step_validation_report_step_id"), table_name="step_validation"
    )
    ...
    op.drop_index(
        "idx_report_steps_data", table_name="report_steps", postgresql_using="gin"
    )
    ...
    op.drop_index(
        op.f("ix_complaints_customer_complaint_date"), table_name="complaints"
    )
